...
const Header = () => (
  <header>
    <div className="app-logo">
      <img src="https://img.freepik.com/free-vector/detailed-chef-logo-template_23-2148987940.jpg?size=626&ext=jpg&ga=GA1.1.485801197.1701238508&semt=ais" />
    </div>
...
const RestaurantCard = (props) => {
  console.log("props", props.resData.name);
  const { resData } = props;
  ...
  return (
    <div className="restaurant-card">
      ...
      <p>{avgRating}</p>
      <p>{costForTwo}</p>
      <p>Will deliver in {deliveryTime}</p>
    </div>
  );
};
